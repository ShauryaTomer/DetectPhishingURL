        ...
        try:
            for head in self.soup.find_all('head'):
                for head.link in self.soup.find_all('link', href=True):
                    ...
                    if self.url in head.link['href'] or len(
                            dots) == 1 or self.domain in head.link['href']:
                        return 1
            return -1
        except:
            return -1
    ...
    def RequestURL(self):
        try:
            for img in self.soup.find_all('img', src=True):
                ...
                if self.url in img['src'] or self.domain in img['src'] or len(
                        dots) == 1:
                    success = success + 1
                i = i + 1
            ...
            for audio in self.soup.find_all('audio', src=True):
                ...
                if self.url in audio['src'] or self.domain in audio[
                        'src'] or len(dots) == 1:
                    success = success + 1
                i = i + 1
            ...
            for embed in self.soup.find_all('embed', src=True):
                ...
                if self.url in embed['src'] or self.domain in embed[
                        'src'] or len(dots) == 1:
                    success = success + 1
                i = i + 1
            ...
            for iframe in self.soup.find_all('iframe', src=True):
                ...
                if self.url in iframe['src'] or self.domain in iframe[
                        'src'] or len(dots) == 1:
                    success = success + 1
                i = i + 1
    ...
    def AnchorURL(self):
        try:
            ...
            for a in self.soup.find_all('a', href=True):
                ...
                ) or "mailto" in a['href'].lower() or not (
    ...
    def LinksInScriptTags(self):
        try:
            ...
            for link in self.soup.find_all('link', href=True):
                ...
                if self.url in link['href'] or self.domain in link[
                        'href'] or len(dots) == 1:
                    success = success + 1
                i = i + 1
            ...
            for script in self.soup.find_all('script', src=True):
                ...
                if self.url in script['src'] or self.domain in script[
                        'src'] or len(dots) == 1:
                    success = success + 1
                i = i + 1
            ...
            if len(self.soup.find_all('form', action=True)) == 0:
                ...
                for form in self.soup.find_all('form', action=True):
                    if form['action'] == "" or form['action'] == "about:blank":
                        return -1
                    elif self.url not in form[
                            'action'] and self.domain not in form['action']:
                        return 0
                    else:
                        return 1
        except:
